[![Build Status](https://travis-ci.org/akveo/camile-client-app.svg?branch=master)](https://travis-ci.org/akveo/camile-client-app)
[![Join the chat at https://gitter.im/camile-client-app/Lobby](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/camile-client-app/Lobby?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
[![Dependency Status](https://david-dm.org/akveo/camile-client-app/status.svg)](https://david-dm.org/akveo/camile-client-app)
...
## Documentation
Installation, customization and other useful articles: https://akveo.github.io/camile-client-app/

## Based on
Angular 2+, Angular CLI, Bootstrap 4, and lots of awesome modules and plugins

## ngx-admin-next
The next major release is under development in https://github.com/akveo/camile-client-app/tree/ngx-admin branch.
